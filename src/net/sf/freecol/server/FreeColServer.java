...
public final class FreeColServer {
     ...
     */
    public void saveMapEditorGame(File file, BufferedImage image, String author)
        throws IOException {
        this.setAIMain(null);
        // Mask out spec while saving map.
        Specification spec = getSpecification();
        getGame().setSpecification(null);
        saveGame(file, MAP_EDITOR_NAME, null, null, image, author);
    ...
    private void saveGame(File file, String owner, OptionGroup options,
                          Unit active, BufferedImage image, String author) throws IOException {
        ...
        try (JarOutputStream fos = new JarOutputStream(Files
            ...
            try (
                ...
                xw.writeAttribute(AUTHOR_TAG, author);
